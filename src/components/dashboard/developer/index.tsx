import { GitBranch, ListTodo, Clock, CheckCircle2, FolderGit2, Blocks, CreditCard, Trophy } from 'lucide-react';
import {
    Card,
    CardContent,
    CardDescription,
...
const navItems = [
  { href: '#', icon: FolderGit2, label: 'My Projects' },
  { href: '#', icon: Blocks, label: 'Modules' },
  { href: '#', icon: CreditCard, label: 'Payments' },
  { href: '#', icon: Trophy, label: 'Achievements' },
];
